...
function setOldImage1()
{
    ...
    document.getElementById("img1").src="https://cdn.educba.com/academy/wp-content/uploads/2016/03/Python-Programming-for-the-Absolute-Beginner.jpg";
...
function setOldImage2()
{
    ...
    document.getElementById("img2").src="https://www.game-designers.net/wp-content/uploads/2019/12/JavaScript-Tutorial-for-Beginners-Learn-JavaScript-in-1-Hour-2019.jpg";
...
function setOldImage3()
{
    ...
    document.getElementById("img3").src="https://i.ytimg.com/vi/eIrMbAQSU34/maxresdefault.jpg";
...
function setOldImage4()
{
    ...
    document.getElementById("img4").src="https://process.fs.teachablecdn.com/ADNupMnWyR7kCWRvm76Laz/resize=width:705/https://www.filepicker.io/api/file/fGWjtyQtG4JE7UXgaPAN";
...
function setOldImage5()
{
    ...
    document.getElementById("img5").src="https://ourcodeworld.com/public-media/articles/articleocw-5d653602443b7.webp";
...
function setOldImage6()
{
    ...
    document.getElementById("img6").src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKX2rc3-Um-Vw0kH9gEDe35s8C61TwXBTvMw&usqp=CAU";
...
function setOldImage7()
{
    ...
    document.getElementById("img7").src="https://i.morioh.com/2020/02/03/32bd329b87ed.jpg";
...
function setOldImage8()
{
    ...
    document.getElementById("img8").src="https://www.hostingclues.com/wp-content/uploads/Learning-HTML-for-Beginners-Banners.png";
